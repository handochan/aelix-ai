...
class EventRenderer:
    ...
    def __init__(
        ...
        *,
        ...
        # (shell.py:729, 1051, 2151) — without asking each to remember.
    ...
    def _render_turn_abort(self, message: object) -> None:
        ...
        CANCELLING the turn task, and the close-out (harness/core.py:4726-4742)
        ...
        ``agent_loop`` (core.py:4682-4688, loop.py:107), so no adapter can raise
    ...
    def _thinking_tail_source(self, width: int) -> str:
        ...
        subscriber synchronously (harness/core.py:2039). At 50KB, 98% of the
    ...
    def _push_thinking_tail(self) -> None:
        ...
        if self._text_stream is not None:
            ...
            # write the same last-writer-wins sink (shell.py:3387). A provider
