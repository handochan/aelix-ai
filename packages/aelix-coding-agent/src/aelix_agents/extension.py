...
``Permission`` (``entry.py:1473-1475`` documents Guardrail-first as a security
...
class AgentsExtension:
    ...
    smuggled through ``event.args`` even though ``harness/core.py:3989-3991``
    ...
    async def _execute(
        ...
        security property rather than a style rule. ``harness/core.py:3989-3991``
