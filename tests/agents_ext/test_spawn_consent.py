...
# (``runtime.py:595-600`` passes a bare ``str``) would have type-checked green
...
async def test_agents_run_renders_the_single_task_body_unchanged(
    ...
    (``runtime.py:595-600``). This test renders that dialog through the real
...
# (``print_channel.py:454``) validated only containment and is-a-directory,
