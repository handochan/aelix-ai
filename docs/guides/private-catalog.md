...
that belong to the installer (see [ADR-0188](../decisions/0188-issue65-discover-catalog.md)
...
The contract is defined by [ADR-0188](../decisions/0188-issue65-discover-catalog.md);
[ADR-0207](../decisions/0207-a-catalog-listed-pack-must-bind-a-manifest.md) covers what
...
- [ADR-0188](../decisions/0188-issue65-discover-catalog.md) — the catalog format
  and why it is advisory.
- [ADR-0192](../decisions/0192-issue76-default-catalog-opt-out.md) — the built-in
  default and its opt-out.
- [ADR-0207](../decisions/0207-a-catalog-listed-pack-must-bind-a-manifest.md) — manifest
