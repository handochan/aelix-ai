...
- `05-post-beta-direction.md`: 베타 이후 제품 방향·운영 제안(2026-09-15, Draft). Claude·Codex 초안을 합친 정본
- `guides/`: 사용자 가이드(설치/실행/provider/models.json/extension 작성/에이전트 프로필/프로젝트 신뢰/프라이빗 카탈로그). 인덱스는 [`guides/README.md`](guides/README.md) 참조. 이 디렉터리는 휠 안에도 복사되어 들어가며, 설치된 환경에서는 `aelix docs`로 읽습니다(ADR-0218)
